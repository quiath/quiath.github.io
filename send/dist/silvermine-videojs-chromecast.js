...
ChromecastTech = {
    ...
    * where `0` is muted and `1` is the loudest volume level. Setting volume for "master"
    * is disabled.
    *
   ...
   setVolume: function(volumeLevel) {
      var castSession = this._getCastSession();
      if (castSession && castSession.getCastDevice().volume.controlType === chrome.cast.VolumeControlType.MASTER) {
          return;
      }
